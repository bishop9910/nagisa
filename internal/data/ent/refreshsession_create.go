...
func (_c *RefreshSessionCreate) SetNillableUserID(v *uuid.UUID) *RefreshSessionCreate {
	if v != nil {
		_c.SetUserID(*v)
	}
	return _c
...
func (_c *RefreshSessionCreate) SetIP(v string) *RefreshSessionCreate {
	_c.mutation.SetIP(v)
	return _c
}

// SetNillableIP sets the "ip" field if the given value is not nil.
func (_c *RefreshSessionCreate) SetNillableIP(v *string) *RefreshSessionCreate {
	if v != nil {
		_c.SetIP(*v)
	}
	return _c
...
func (_c *RefreshSessionCreate) SetLastUsedAt(v time.Time) *RefreshSessionCreate {
	_c.mutation.SetLastUsedAt(v)
	return _c
}

// SetNillableLastUsedAt sets the "last_used_at" field if the given value is not nil.
func (_c *RefreshSessionCreate) SetNillableLastUsedAt(v *time.Time) *RefreshSessionCreate {
	if v != nil {
		_c.SetLastUsedAt(*v)
	}
	return _c
...
func (_c *RefreshSessionCreate) defaults() {
	...
	if _, ok := _c.mutation.UserID(); !ok {
		v := refreshsession.DefaultUserID()
		_c.mutation.SetUserID(v)
	}
	if _, ok := _c.mutation.IP(); !ok {
		v := refreshsession.DefaultIP
		_c.mutation.SetIP(v)
	}
...
func (_c *RefreshSessionCreate) check() error {
	...
	if v, ok := _c.mutation.TokenHash(); ok {
		if err := refreshsession.TokenHashValidator(v); err != nil {
			return &ValidationError{Name: "token_hash", err: fmt.Errorf(`ent: validator failed for field "RefreshSession.token_hash": %w`, err)}
		}
	}
	if _, ok := _c.mutation.IP(); !ok {
		return &ValidationError{Name: "ip", err: errors.New(`ent: missing required field "RefreshSession.ip"`)}
	}
	if _, ok := _c.mutation.UserAgent(); !ok {
...
func (_c *RefreshSessionCreate) createSpec() (*RefreshSession, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UserID(); ok {
		_spec.SetField(refreshsession.FieldUserID, field.TypeUUID, value)
		_node.UserID = value
	}
	...
	if value, ok := _c.mutation.IP(); ok {
		_spec.SetField(refreshsession.FieldIP, field.TypeString, value)
		_node.IP = value
	}
