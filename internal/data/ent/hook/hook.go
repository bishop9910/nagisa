...
// The NodeAclFunc type is an adapter to allow the use of ordinary
// function as NodeAcl mutator.
type NodeAclFunc func(context.Context, *ent.NodeAclMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NodeAclFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NodeAclMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NodeAclMutation", m)
}
...
// The PendingDeletionFunc type is an adapter to allow the use of ordinary
// function as PendingDeletion mutator.
type PendingDeletionFunc func(context.Context, *ent.PendingDeletionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PendingDeletionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PendingDeletionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PendingDeletionMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f UploadPartFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UploadPartMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UploadPartMutation", m)
}
