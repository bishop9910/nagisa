...
func (*RefreshSession) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case refreshsession.FieldTokenHash, refreshsession.FieldIP, refreshsession.FieldUserAgent:
			values[i] = new(sql.NullString)
		case refreshsession.FieldCreatedAt, refreshsession.FieldUpdatedAt, refreshsession.FieldExpiresAt, refreshsession.FieldRevokedAt, refreshsession.FieldLastUsedAt:
