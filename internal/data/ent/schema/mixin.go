...
// newZeroUUID is the sentinel used by the reference columns that stand for
// "no parent", "no owner yet" or "created by the bootstrapper". It is a
// function because ent requires a callable default for UUID columns.
func newZeroUUID() uuid.UUID {
	return uuid.Nil
}
